...
public class MascotaController {
	...
	public String actualizar(ModelMap modelo, HttpSession session, MultipartFile archivo, @RequestParam String id, @RequestParam String nombre, @RequestParam Tipo tipo, @RequestParam Sexo sexo) {
		...
		try {
			...
			if(id == null || id.isEmpty()) {
				...
				mascotaServicio.agregarMascota(archivo, usuario.getId(), nombre, tipo, sexo);
				
			} else {
				
				mascotaServicio.modificar(archivo, usuario.getId(), id, nombre, tipo, sexo);
